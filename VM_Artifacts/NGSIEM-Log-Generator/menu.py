...
# Debug Logs enabled is loaded at the start of the script
config = load_config()
debug_logs_enabled = config.get('debug_logs_enabled', True)
...
║  9. Contact Data Owner to disable debug logs                ║
║  0. Back to main menu                                       ║
╚═════════════════════════════════════════════════════════════╝
        """)
        choice = input("Enter your choice: ").strip()
        ...
        if choice == '1':
            ...
            config['debug_logs_enabled'] = debug_logs_enabled
            save_config(config)
            print("You have contacted the Data Owner. Debug logs will stop being forwarded.")
        elif choice == '0':
            break
        else:
            print("Invalid choice. Please try again.")
